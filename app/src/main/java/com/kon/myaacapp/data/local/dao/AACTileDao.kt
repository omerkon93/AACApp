package com.kon.myaacapp.data.local.dao
...
import com.kon.myaacapp.data.local.entity.AACTileWithPlacement
...
interface AACTileDao {
    ...
    @Query(
        """
    DELETE FROM tile_click_events
    WHERE profileId = :profileId
    """
    )
    suspend fun deleteClickEventsForProfile(
        profileId: String,
    )
